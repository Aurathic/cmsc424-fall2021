...
# Let right contain the tuples: (b1), (b2), .., (bk)
# Output then has the schema: output schema = (A, C) -- i.e., the attributes present in "left", but not in "right"
# A tuple (a1, c1) is output if all of: (a1, b1, c1), (a1, b2, c1), ..., (a1, bk, c1) are present in "left"
#
# You can assume that there are NO DUPLICATES in either of the input relations, and that BOTH INPUTS are "SequentialScans" (you need that assumption to get the schema)
#
# There are more details in the book on this operation
#
